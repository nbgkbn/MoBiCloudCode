...
var seteeRecord = function (businessObject) {
    ...
    else
    {
        ...
        eRecord["SoftwareCreator"] = _val[0];
        v2Array.push({ section: "E01", element: "E01_02", val: _val[0] });
    };
    ...
    {
        v2Array.push({ section: "E01", element: "E01_04", val: _val[0] });
        eRecord["eRecord.04"] = _val[0];
        eRecord["SoftwareVersion"] = _val[0];
    };
};
