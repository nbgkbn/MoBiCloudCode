...
var seteDispatch = function (businessObject) {
    ...
    eDispatchObject = getNEMSISSection(businessObject, "eDispatch")
...
function setV2(NEMSISElementNumber, value) {
    ...
    switch (NEMSISElementNumber) {
        case "eDispatch.01":
            ...
            if (eDispatch01[value] == undefined) {
                _retVal = value + " UNDEFINED";
            }
            else {
                _retVal= eDispatch01[value];
            }
            break;

        case "eDispatch.02":

            if (eDispatch02[value] == undefined) {
                _retVal = value + " UNDEFINED";
            }
            else {
                _retVal= eDispatch02[value];
            }
            break;

        default:
            _retVal= NEMSISElementNumber = " version 2 not found";
    }
